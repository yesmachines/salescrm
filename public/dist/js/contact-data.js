...
$(function () {
	...
	if ($("#vdatable_1").length > 0) {
		...
		var targetDt = $('#vdatable_1').DataTable({
			"paging": true,
			"columnDefs": [{
				"searchable": false,
				"orderable": false,
		...
		$("#vdatable_1").parent().addClass('table-responsive');

		/*Select all using checkbox*/
		var DT1 = $('#vdatable_1').DataTable();
	...
	if ($("#rdatable_1").length > 0) {

		var targetDt = $('#rdatable_1').DataTable({
			"paging": true,
			"lengthChange": true,
			"searching": true,
			"ordering": true,
		...
		$("#rdatable_1").parent().addClass('table-responsive');

	}

	if ($("#edatable_1").length > 0) {

		/*Checkbox Add*/
		var tdCnt = 0;

		var targetDt = $('#edatable_1').DataTable({
			"paging": true,
			"columnDefs": [{
				"searchable": false,
				"orderable": false,
		...
		$("#edatable_1").parent().addClass('table-responsive');

	}

	if ($("#com_datatable").length > 0) {
		var targetDt = $('#com_datatable').DataTable({
			"paging": true,
			"lengthChange": true,
			"searching": true,
			"ordering": true,
		...
		$("#com_datatable").parent().addClass('table-responsive');
	}
