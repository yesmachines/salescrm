...
<div class="title title-xs title-wth-divider text-primary text-uppercase my-2" style="padding-top:21px;padding-bottom: 20px;"><span>Additional Charges</span></div>
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <input class="form-check-input" type="radio" name="vat_option" id="vat_include" value="1">
      <label class="form-check-label" for="vat_include">
        Include
      </label>
      <input class="form-check-input" type="radio" name="vat_option" id="vat_exclude" value="0"  checked>
