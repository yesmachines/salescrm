    ...
    <table class="table" id="product_item_tbl">
      ...
      <tbody>
        ...
        <tr id="irow-{{$item->item_id}}">
          ...
          <td><div class="form-check">  <input type="hidden" name="discount_status[]" value="{{ $item->discount_status }}"><input type="checkbox" class="form-check-input" name="discount_option[]" value="1" onchange="updateCheckboxValue(this)" @if($item->discount_status == 1) checked @endif /></div></td>
