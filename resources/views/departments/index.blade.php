                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-3">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_new_department">Add New Department</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex">
                                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" id="edit_department" href="#" title="" data-bs-original-title="Edit" data-bs-toggle="modal" data-bs-target="#edit_department_modal" data-bs-toggle="tooltip" data-placement="top" data-id="{{ $department->id }}"><span class="icon"><span class="feather-icon"><i data-feather="edit"></i></span></span></a>
                                        ...
                                        document.getElementById('delete-form-{{ $department->id }}').submit();"><span class="icon"><span class="feather-icon"><i data-feather="trash"></i></span></span></a>
                                                    {!! Form::open(['method' => 'DELETE','route' => ['departments.destroy', $department->id],'style'=>'display:none',
