                                        ...
                                        style="color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                          <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                                            <div style="margin:50px auto;padding:20px 0">
                                              ...
                                              <p style="font-size:1.1em">{{trans('email.reset_password.with_name',['user_name' => $mailData->name])}},</p>
                                              <p>{{trans('email.reset_password.content_1')}}</p>
                                              <h2 style="background: #00466a;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">{{trans('email.reset_password.otp')}} :  {{$mailData->otp}}</h2>
                                              <p style="font-size:0.9em;">{{trans('email.reset_password.content_2')}},<br />{{trans('email.reset_password.content_3')}}</p>
