...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title> Otp for forgot password: Yes Machinery </title>
                                            ...
                                            <div class="region">
                                                <div>
                                                    <table class="row aw-stack"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="container" style="padding: 30px 20px; width: 100%; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-collapse: collapse;
                                                                    ...
                                                                    <div class="definition-parent"><span>
                                                                            <table align="center" width="100%" class="floated-none"
                                                                                   style="float: none; text-align: center; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;"
                                                                                   role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            style="padding: 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">

                                                                                            <img class="model"
                                                                                                 src="{{asset('images/logo.jpeg')}}"
                                                                                                 style="display: block; width: 80px;  border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 0px;"
                                                                                                 alt="Logo" width="80">
                                            ...
                                            <div class="region">
                                                <div>
                                                    ...
                                                    <table class="row aw-stack"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="container" style="padding: 30px; width: 100%; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-collapse:
                                                                    ...
                                                                    <div class="definition-parent">
                                                                        <div class="text-element paragraph">
                                                                            <div
                                                                                style="color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                                                                <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                                                                                    {{$mailData->title}}
                                                                                    @if(!empty($mailData->business_card))
                                                                                    <img class="model"
                                                                                         src="{{$mailData->business_card}}"
                                                                                         style="display: block; width: 200px;  border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 0px;"
                                                                                         alt="Business Card" width="200">
                                                                                    @endif
                                                                                    <div style="margin:0px 50px 50px auto; padding:10px 0">
                                                                                        <p style="font-size:1.1em">Shared By: {{$mailData->sharedBy->name}}</p>
                                                                                        <p style="font-size:1.1em">Meeting Held On: {{$mailData->date}}</p>
                                                                                        <p style="margin-bottom:10px;"></p>
                                                                                        <p>Company Name: {{$mailData->company_name}}</p>
                                                                                        <p>Company Representative: {{$mailData->company_representative}} </p>
                                                                                        <p>Contact Number: {{$mailData->phone}} </p>
                                                                                        <p>Email: {{$mailData->email}} </p>
                                                                                        <p>Location: {{$mailData->location}} </p>
                                                                                        @if(!$mailData->products->isEmpty())
                                                                                        <h2 style="width: max-content;padding: 0 10px;color: #000;border-radius: 4px;">Products</h2>
                                                                                        @foreach($mailData->products as $product)
                                                                                        <p style="font-size:0.9em;">{{$product->title}},<br />{{$product->brand}}</p>
                                                                                        <hr style="border:none;border-top:1px solid #eee; width: 100%;" />
                                                                                        @endforeach
                                                                                        @endif
                                                                                        <p style="margin-top:10px;"></p>
                                                                                        <p>Meeting Notes: <br />{{$mailData->meeting_notes}} </p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="divider-container"
                                                                                            style="padding: 20px 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
                                                                                            <table width="100%" role="presentation"
                                                                                                   style="border-width: 1px 0px 0px; border-style: solid none none; border-top-color: rgb(222, 224, 232); border-collapse: collapse; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-spacing: 0px; font-size: 18px;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td width="100%"
                                                                                                            style="text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
                                        ...
                                        <div class="temp-fullbleed contained" style="max-width: 600px; width: 100%;">
                                            <div class="region">
                                                <div>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <!--[if mso]>&nbsp;<![endif]-->
                                                                                            <a href="https://www.instagram.com/yes_machinery/?utm_source=ig_profile_share&igshid=rwb4cto40an5"
                                                                                               style="display: inline-block; font-size: 0; vertical-align: top; margin: 0.25rem; height: 24px; width: 24px;"
                                                                                               target="_blank" rel="noopener noreferrer">
                                                                                                <img
                                                                                                    style="height: 24px; width: 24px; border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 10px;"
                                                                                            ...
                                                                                            <!--[if mso]>&nbsp;<![endif]-->
                                                                                            <a href="https://www.linkedin.com/company/yes-machinery"
                                                                                               style="display: inline-block; font-size: 0; vertical-align: top; margin: 0.25rem; height: 24px; width: 24px;"
                                                                                               target="_blank" rel="noopener noreferrer">
                                                                                                <img
                                                                                                    style="height: 24px; width: 24px; border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 10px;"
                                                                        ...
                                                                        <div class="text-element paragraph">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    YORK ENGINEERING SOLUTIONS FZC  <br>
                                                                                ...
                                                                                <div
                                                                                    style="text-align: center; color: rgb(124, 124, 124); font-family: 'Exo 2', sans-serif; font-size: 14px; line-height: 125%; font-weight: 400;">
                                                                                    <br>
                                                                                    <a class="validating" href="https://www.yesmachinery.ae/pages/privacy-policy"
                                                                                       ...
                                                                                       href="https://www.yesmachinery.ae/contact"
                                                                                       style="color:#017ac9; font-weight: 100; font-size: 13px;" target="_blank"
                                                    ...
                                                    <table style="width: 100%; border-spacing: 0; padding: 6px 0; background: #9dc33b; letter-spacing: 2px; border-radius: 0 0 8px 8px; margin-top: 20px;">
                                                        <tbody><tr>
                                                                <td style="width: 100%; text-align: center;">
                                                                    <a style="text-decoration: none; color: #fff; margin: 0; font-size: 12px;"> www.yesmachinery.ae </a>
                                                                </td>
                                                            </tr>
                                                        </tbody></table>
