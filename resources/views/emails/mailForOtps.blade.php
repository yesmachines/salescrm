...
<head>
  <meta charset="UTF-8">
  <title> Otp for Order Tracker: Yes Machinery </title>
                                        ...
                                        style="color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                          <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                                            <div style="margin:50px auto;padding:20px 0">
                                              ...
                                              <p>Use the following OTP to track your order. OTP is valid for 12 minutes</p>
                                              <h2 style="background: #00466a;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">{{ $data['random'] }}</h2>
                                              <p><a href="{{env('APP_FRONT_URL')}}track/otp/{{$data['po_number']}}">Click here to Enter Otp</a></p>
                                              <p style="font-size:0.9em;">Regards,<br />Yes Machinery</p>
