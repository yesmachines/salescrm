                    ...
                    <tr valign="top" id="row-p{{$item->item_id}}" data-index="{{$x}}">
                        ...
                        <td width="12%">
                            ...
                            <div class="purchase mt-3">
                                ...
                                @else
                                <a href="javascript:void(0);" class="b-price-add btn btn-primary btn-sm" data-pid="{{$item->item_id}}" data-bs-toggle="modal" data-bs-target="#addpurchase"> <i class="fas fa-plus"></i> ADD</a>
                                @endif
                            </div>
                        </td>
                        <td width="8%">
