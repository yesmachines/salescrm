  ...
  <div class="row">
      ...
      <table class="table form-table" id="itemcustomFields">
        ...
        <tbody>
          ...
          <tr valign="top">
            ...
            <td>
              <input type="number" class="form-control" name="total_amount[]" value=""  step="any" placeholder="Total Amount" />
            </td>
            <td width="8%">
    ...
    <div class="row mb-2">
      ...
      <div class="col-6">
        <input type="text" class="form-control" id="buying_price" name="buying_price" readonly>
      </div>
      <div class="col-2"></div>
    </div>
  </div>
