...
@section('title') Reports of {{$title}} Leads @endsection
                            ...
                            <table id="rdatable_1" class="table nowrap w-100 mb-5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$cust->company->company}} ({{$cust->lead_type}})</td>
                                        <td class="text-truncate">{{$cust->customer->fullname}}</td>
                                        <td>{{$cust->enquiry_date}}</td>
                                        <td width="20%">{{ $cust->details }}</td>
                                        <td><span class="badge badge-soft-violet my-1  me-2">{{$cust->assigned->user->name}}</span></td>
                                        <td>{{$cust->assigned_on}}</td>
                                        <td>{{$cust->respond_on}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
