...
@section('title') Reports of Supplier Sales @endsection
                    ...
                    <div data-simplebar class="nicescroll-bar">
                        ...
                        <div class="contact-list-view">
                                ...
                                <div class="col">
                                    <form method="GET">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <button class="btn btn-secondary" type="button" onclick="window.location.href='/reports/leads'">Reset</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <table id="rdatable_1" class="table nowrap w-100 mb-5">
                                ...
                                <tbody>
                                    @foreach($brandSummary as $i => $sup)
                                    <tr>
                                        <td>{{ $i + 1}}</td>
                                        <td>{{$sup->brand}}</td>
                                        <td>{{$sup->quotecount}}</td>
                                        <td>{{$sup->salesvalue}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
