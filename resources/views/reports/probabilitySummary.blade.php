...
@section('title') Reports of Winning Probability @endsection
                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown">
                            <a class="contactapp-title link-dark" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <h1>Winning Probability Summary</h1>
                            </a>
                        </div>
                    ...
                    <div data-simplebar class="nicescroll-bar">
                        ...
                        <div class="contact-list-view">
                            ...
                            <div class="row">
                                <div class="col">
                                    <form method="GET">
                                        <label class="form-label">Search By Closing Date</label>
                                        <div class="input-group mb-3">
                                            ...
                                            <button class="btn btn-secondary" type="button" onclick="window.location.href='/reports/probability'">Reset</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <table id="rdatable_1" class="table nowrap w-100 mb-5">
                                ...
                                <tbody>
                                    @foreach($probabilitySummary as $i => $prob)
                                    <tr>
                                        <td>{{ $i + 1}}</td>
                                        <td>{{(int) $prob->winning_probability}} %</td>
                                        <td>{{$prob->quotecount}}</td>
                                        <td>{{$prob->salesvalue}}</td>
                                        <td>{{$prob->value}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
