              ...
              <div class="row">
                ...
                <div class="col-xxl-4 col-lg-5 mt-lg-0 mt-3">
                  <div class="">
                    ...
                    @if($lead->status_id != 6)
                    <div class="dropdown">
                      <button class="btn btn-primary btn-block dropdown-toggle same-width" type="button" id="convertDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        Convert To Quotation
                      </button>
                      <ul class="dropdown-menu same-width" aria-labelledby="convertDropdown">
                        <a href="javascript:void(0);" class="dropdown-item convert-leads-to" data-id="{{ $lead->id }}" data-type="sales">Sales</a>
                        <a href="javascript:void(0);" class="dropdown-item convert-leads-to" data-id="{{ $lead->id }}" data-type="service">Service</a>
                      </ul>
                    </div>
