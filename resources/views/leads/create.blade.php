        ...
        <form method="POST" action="{{ route('leads.store') }}" enctype="multipart/form-data">
          ...
          <div class="row gx-3">
            <div class="col-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" type="text" name="company" id="company" required readonly/>
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" type="text" name="fullname" id="fullname" required readonly/>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
