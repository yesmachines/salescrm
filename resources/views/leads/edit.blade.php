...
<div class="container-xxl">
        ...
        <div class="row gx-3">
          <div class="col-sm-6">
            ...
            <div class="row gx-3 mt-4">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" type="text" name="company" id="company" value="{{$lead->company->company}}" required readonly/>
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" type="text" name="fullname" id="fullname" value="{{ $lead->customer->fullname}}" required readonly/>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <select class="form-select" name="country_id" id="country_id" required readonly>
                    <option value="">--</option>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select class="form-select" name="region_id" id="region_id" readonly>
  ...
  <div class="col-sm-6">
    <div class="form-group">
      <input class="form-control" type="email" name="email" id="email" value="{{$lead->customer->email}}" readonly/>
    </div>
  </div>
  <div class=" col-sm-6">
    <div class="form-group">
  ...
  <div class=" col-sm-6">
    <div class="form-group">
      <input class="form-control" type="text" name="phone" id="phone" value="{{$lead->customer->phone}}" required readonly/>
    </div>
  </div>
</div>
</div>
    ...
    <div class="col-sm-6">
      <div class="form-group">
        <select class="form-select" name="enquiry_mode" id="enquiry_mode">
          ...
          <option value="{{$k}}" {{ ($lead->enquiry_mode == $k)? "selected": "" }}>{{ $enum->label() }}</option>
          @endforeach
        </select>
      </div>
    </div>
