        ...
        <div class="menu-content-wrap">
            ...
            <div class="menu-group">
                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#meetings">
                            <span class="nav-icon-wrap">
                                <span class="svg-icon">
                            ...
                            <span class="nav-link-text">Meeting Reports</span>
                        </a>
                        <ul id="meetings" class="nav flex-column collapse  nav-children">
                            <li class="nav-item">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('permissions.index')}}"><span class="nav-link-text">Shared Meetings</span></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
