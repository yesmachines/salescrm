                    ...
                    <div class="dropdown ps-2">
                        <a class=" dropdown-toggle no-caret" href="#" role="button" data-bs-display="static" data-bs-toggle="dropdown" data-dropdown-animation data-bs-auto-close="outside" aria-expanded="false">
                            <div class="avatar avatar-rounded avatar-xs">
                                ...
                                <img src="{{asset('storage/'. $_employee->image_url)}}" alt="user" class="avatar-img">
                                @else
                                ...
                                <div class="media">
                                    <div class="media-head me-2">
                                        <div class="avatar avatar-primary avatar-sm avatar-rounded">
                                            <span class="initial-wrap">{{substr(Auth::user()->name, 0, 2)}}</span>
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="dropdown">
                                            <a href="#" class="d-block link-dark fw-medium" data-dropdown-animation data-bs-auto-close="inside">{{ Auth::user()->name }}</a>
                                            <!-- <div class="dropdown-menu dropdown-menu-end">
                                                <div class="p-2">
                                                    <div class="media align-items-center active-user mb-3">
                                                        ...
                                                        <div class="media-body">
                                                            <a href="#" class="d-flex align-items-center link-dark">{{ Auth::user()->name }}
                                                                <i class="ri-checkbox-circle-fill fs-7 text-primary ms-1"></i></a>
                                        ...
                                        <a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="d-block fs-8 link-secondary">
                                            <u>Sign Out</u></a>
