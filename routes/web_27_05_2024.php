...
Route::group(['middleware' => ['auth', 'permission']], function () {
    ...
    Route::post('stock/savestep1', [StockController::class, 'stockStep1'])->name('stock.savestep1');
    Route::post('stock/savestep2', [StockController::class, 'stockStep2'])->name('stock.savestep2');
    Route::post('stock/savestep3', [StockController::class, 'stockStep3'])->name('stock.savestep3');
    Route::post('stock/savestep4', [StockController::class, 'stockStep4'])->name('stock.savestep4');
    Route::get('stockList', [StockController::class, 'index'])->name('stockList');
