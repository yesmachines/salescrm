...
class StockController extends Controller
{
  ...
  public function edit(int $id,StockService $stockService,EmployeeService $employeeService)
  {
    ...
    return view('stock._stock_edit', compact(
      ...
      'stockCharges',
      'stockItems',
      'suppliers','currencies','terms','employees'
    ));
  }
  ...
  public function downloadStockOS( $id, StockService $stockService)
  {
    ...
    ->with(compact(
      'stockService','stockItems','stockPayments','stockSuppliers','stockCharges'
      ))
      ->render();
