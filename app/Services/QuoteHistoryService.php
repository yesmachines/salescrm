...
class QuoteHistoryService
{
  ...
  public function getHistoriesData($quoteId): Object
  {
    return DB::table('quotation_histories as q')
    ->leftJoin('quotations as qs', 'q.quotation_id', '=', 'qs.id')
    ->select('q.*', 'qs.reference_no')
