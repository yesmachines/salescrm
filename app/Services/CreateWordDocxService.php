  ...
  foreach ($quotationItems as $value) {
      ...
      if (!isset($addedSuppliers[$supplierName])) {
        ...
        if ($quotationItems->isNotEmpty()) {
          ...
          <tr>
          <td style="border: 1px solid #9DC33B; padding: 8px; font-weight: bold; background-color: #9DC33B; color: white; font-size: 10pt; font-family: Calibri;">S.No</td>
          ...
          $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-weight: bold; background-color: #9DC33B; color: white; font-size: 10pt; font-family: Calibri;">Qty</td>';
          if (collect($quotationItems)->contains('discount_status', 1)){
            $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-weight: bold; background-color: #9DC33B; color: white; font-size: 10pt; font-family: Calibri;">Discount</td>';
          }
          $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-weight: bold; background-color: #9DC33B; color: white; font-size: 10pt; font-family: Calibri;">Total Amount</td>
          </tr>';
          ...
          foreach ($quotationItems as $key => $value) {
            ...
            $html .= '<tr>';
            $html .= '<tr>';
            $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-size: 10pt; font-family: Calibri;">' . $s_no. '</td>';
            $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-size: 10pt; font-family: Calibri;">';
          ...
          $html .= '<tr>
          <td colspan="' . $discountColspan . '" style="font-size: 10pt; font-family: Calibri; border: 1px solid #9DC33B; padding: 8px; text-align: left; font-weight: bold; background-color: #9DC33B; color: white;">Additional Charges</td>
          </tr>';
          foreach ($quotationCharges as $key => $getQuotioncharge) {
            $html .= '<tr>';
            $html .= '<td colspan="' . ($discountColspan - 1) . '" style="border: 1px solid #9DC33B; padding: 8px; text-align: right; font-size: 10pt; font-family: Calibri;">' . htmlspecialchars(str_replace("&", " ", $getQuotioncharge['title'])) . '</td>';
          ...
          if($quotation->quote_for == 'service' && $quotation->is_vat == 1){
            $html .= '
            <tr>
            <td colspan="' . ($discountColspan - 1) . '" style="font-size: 10pt; font-family: Calibri; border: 1px solid #9DC33B; padding: 8px; text-align: right;font-weight: bold;">Vat For Service (Include 5%)</td>
            <td style="border: 1px solid #9DC33B; padding: 8px;font-size: 10pt; font-family: Calibri;">' . htmlspecialchars(number_format($quotation->vat_amount, 2)) . ' ' . $quotation->preferred_currency . '</td>
            </tr>';
          }
          if ($quotation->is_vat == 1 && $quotation->quote_for != 'service') {
            $html .= '
            <tr>
            <td colspan="' . ($discountColspan - 1) . '" style="font-size: 10pt; font-family: Calibri; border: 1px solid #9DC33B; padding: 8px; text-align: right;font-weight: bold;">Vat Amount (Include 5%)</td>
            <td style="border: 1px solid #9DC33B; padding: 8px;font-size: 10pt; font-family: Calibri;">' . htmlspecialchars(number_format($quotation->vat_amount, 2)) . ' ' . $quotation->preferred_currency . '</td>
            </tr>';
          } else if ($quotation->quote_for != 'service') {
            $html .= '
            <tr>
            <td colspan="' . ($discountColspan - 1) . '" style="border: 1px solid #9DC33B; padding: 8px; text-align: right;font-weight: bold;font-size: 10pt; font-family: Calibri;">Vat Amount</td>
            <td style="border: 1px solid #9DC33B; padding: 8px;font-size: 10pt; font-family: Calibri;">Exclusive</td>
            </tr>';
          }
          ...
          if ($quotation->total_status != '0') {
            $html .= '
            <tr>
            <td colspan="' . ($discountColspan - 1) . '" style="font-size: 10pt; font-family: Calibri;border: 1px solid #9DC33B; padding: 8px; text-align: right;font-weight: bold;">Total Amount: </td>
        ...
        if ($optionalItems->isNotEmpty()) {
          ...
          <td style="border: 1px solid #9DC33B; padding: 8px; font-weight: bold; background-color: #9DC33B; color: white; font-size: 10pt; font-family: Calibri;">Amount</td>
          </tr>';

          foreach ($optionalItems as $key => $value) {
            $html .= '<tr>';
            $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-size: 10pt; font-family: Calibri;">' . nl2br($value->item_name) . '</td>';
            $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-size: 10pt; font-family: Calibri;">' . nl2br($value->quantity) . '</td>';
            $html .= '<td style="border: 1px solid #9DC33B; padding: 8px; font-size: 10pt; font-family: Calibri;">' . htmlspecialchars(number_format($value->amount, 2)) . ' ' . $quotation->preferred_currency . '</td>';
            $html .= '</tr>';
          }
          $html .= '</table>';
        }
